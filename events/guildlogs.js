...
const join = '1282366289909907516'
const leave = '1282366365788930068'
...
module.exports = async (client) => {
    client.on('guildCreate', async (guild) => {
        ...
        if (guild.partnered && guild.verified)
            emoji = `<:partners:1286960221343973457><:verified:1286994555702345784>`
        else if (guild.partnered && !guild.verified)
            emoji = '<:partners:1286960221343973457>'
        else if (!guild.partnered && guild.verified)
