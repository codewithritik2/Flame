...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/hBvdRJgXzM'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#ff5c00`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/hBvdRJgXzM) was removed.\nClick [here](https://discord.gg/hBvdRJgXzM) To Buy [Premium](https://discord.gg/hBvdRJgXzM).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`#ff5c00`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.com/invite/hBvdRJgXzM) was removed.\nClick [here](https://discord.com/invite/hBvdRJgXzM) To Buy [Premium](https://discord.com/invite/hBvdRJgXzM).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new MessageActionRow().addComponents(
                ...
                new MessageButton()
                    .setLabel(`Support`)
                    .setStyle('LINK')
                    .setURL(`https://discord.com/invite/hBvdRJgXzM`),
                new MessageButton()
                    .setLabel(`Vote`)
                    .setStyle('LINK')
                    .setURL(`https://top.gg/bot/1259218811131793479/vote`)
            )
            ...
            let user = await client.users.fetch(`239496212699545601`)
            ...
            if (
                !'239496212699545601'.includes(message.author.id) &&
                !uprem &&
                !sprem
            ) {
                const row = new MessageActionRow().addComponents(
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.com/invite/hBvdRJgXzM )',
                                    true
                                )
                                .setTimestamp()
            ...
            if (command && command.run) {
                const weboo = new WebhookClient({
                    url: `https://discord.com/api/webhooks/1286939296548392960/utpAj7RUKme-oPZ9jj6_j9wvlRSej8IWsf-pRyueoZVimhSHES56YRMF9uKj0nCUa1VG`
                })
