  ...
  run: async (client, message, args) => {
    ...
    if (!listData) {
      const embed = new MessageEmbed()
        .setTitle("<:invitesss:1289282186553462896> **Invalid list type** ")
        .setDescription("<a:cross:1289282294904918138> **Please provide 'admin', 'bot', 'ban', 'inrole <role name/ID/mention>', 'boosters', 'emojis', or 'roles'.** ")
        .setColor('#ff5c00');
