...
const disabled = '<:tick:1277612193965412364>'
const enabled = '<:tick:1277612193965412364>'
                ...
                embeds: [
                    new MessageEmbed()
                        ...
                        .addFields([
                            {
                                name: '__About__',
                                value: `**Name**: ${guild.name} \n **ID**: ${guild.id} \n **Owner <a:OWNER:1286958811352928290>:** <@!${guild.ownerId}> (${guild.ownerId})\n**Created at:** <t:${parseInt(createdTimestamp / 1000)}:R>\n**Members: **${guild.memberCount}\n**Banned Members: **${bans}`
                            },
                            {
                            ...
                            {
                                name: '__Channels__',
                                value: `**Total: ** ${channels.size}\n**Channels: **<:Text_Channels:1286959326199545857> ${channels.filter((channel) => channel.type === 'GUILD_TEXT').size} | <:Voice_Channels:1286959557867995157> ${channels.filter((channel) => channel.type === 'GUILD_VOICE').size}`
                            },
                            {
                                name: '__Emoji Info__',
                            ...
                            },
                            {
                                ...
                                value: `${booster[guild.premiumTier]} [<a:BOOST:1286959739506393193> ${guild.premiumSubscriptionCount || '0'} Boosts]`
                            },
                            {
