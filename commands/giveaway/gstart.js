  ...
  try {
    ...
    await member.client.giveawaysManager.start(giveawayChannel, {
      ...
      messages: {
        ...
        drawing: '',
        winMessage: '<a:giveaway:1299096208106590319> Congratulations, {winners}! You won **{this.prize}**!',
    ...
    return { embeds: [new MessageEmbed().setColor(giveawayChannel.client.color).setDescription(`<:tick:1277612193965412364> | The giveaway for **${prize}** has been started in ${giveawayChannel}.`)] };
  } catch (error) {
